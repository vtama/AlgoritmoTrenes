...
public class Principal {
	    ...
	    public static void main(String[] args) {
	        ...
	        // Pruebas
	        System.out.println("Salida #1: " + ServicioCalculoTren.calcularDistancia("ABC"));
	        System.out.println("Salida #2: " + ServicioCalculoTren.calcularDistancia("AD"));
	        System.out.println("Salida #3: " + ServicioCalculoTren.calcularDistancia("ADC"));
	        System.out.println("Salida #4: " + ServicioCalculoTren.calcularDistancia("AEBCD"));
	        ...
	        System.out.println("Salida #7: " + ServicioCalculoTren.contarViajesConParadasExactas('A', 'C', 4));
	        System.out.println("Salida #8: " + ServicioCalculoTren.caminoMasCorto('A', 'C'));
